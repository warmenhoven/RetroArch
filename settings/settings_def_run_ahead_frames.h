...
S_UINT_CH(run_ahead_frames, RUN_AHEAD_FRAMES,
      "run_ahead_frames",
      DEFAULT_RUN_AHEAD_FRAMES, SD_FLAG_NONE, SDESC_RANGE_MINMAX, 0, 1, MAX_RUNAHEAD_FRAMES, 1, 1, setting_action_ok_uint, NULL, ST_UI_TYPE_UINT_COMBOBOX, runahead_change_handler,
