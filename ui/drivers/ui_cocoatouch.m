...
{
    runloop_msg_queue_push("Got Metric Payload", 1, 500, false, NULL, MESSAGE_QUEUE_ICON_DEFAULT, MESSAGE_QUEUE_CATEGORY_INFO);
...
{
    runloop_msg_queue_push("Got Diagnostic Payload", 1, 500, false, NULL, MESSAGE_QUEUE_ICON_DEFAULT, MESSAGE_QUEUE_CATEGORY_INFO);
